...
public class ShowVulnTable {
    ...
    private SimpleBooleanProperty  selectedBoolean = new SimpleBooleanProperty(false);
...
//    private SimpleStringProperty vulnTimeString;
    ...
    public void setSelected(boolean selected) {
        ...
        this.selectedBoolean = new SimpleBooleanProperty(selected);
    }
    public void setOnlySelected(boolean selected) {
        this.selected = selected;
    }
    public SimpleBooleanProperty selectedBooleanProperty() {//Perperty()方法的命名，一定要按照 “SimpleStringProperty变量名”+Property() 这样的格式命名，而且该变量名必须要与实体类中定义的SimpleStringProperty属性一致。
